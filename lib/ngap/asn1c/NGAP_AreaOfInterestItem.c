...
asn_TYPE_member_t asn_MBR_NGAP_AreaOfInterestItem_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NGAP_AreaOfInterestItem, locationReportingReferenceID),
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_AreaOfInterestItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_5591P23,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_NGAP_AreaOfInterestItem_oms_1[] = { 1, 2 };
