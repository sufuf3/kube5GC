...
asn_TYPE_member_t asn_MBR_NGAP_AreaOfInterest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_AreaOfInterest, areaOfInterestTAIList),
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_AreaOfInterest, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_5591P22,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_NGAP_AreaOfInterest_oms_1[] = { 1 };
