...
static asn_TYPE_member_t asn_MBR_NGAP_PathSwitchRequestAcknowledgeTransfer_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_PathSwitchRequestAcknowledgeTransfer, uL_NGU_UP_TNLInformation),
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_PathSwitchRequestAcknowledgeTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_5591P69,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_NGAP_PathSwitchRequestAcknowledgeTransfer_oms_1[] = { 1, 2 };
