...
static asn_TYPE_member_t asn_MBR_NGAP_PathSwitchRequestTransfer_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_PathSwitchRequestTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_5591P70,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_NGAP_PathSwitchRequestTransfer_oms_1[] = { 1, 3 };
...
static const asn_TYPE_tag2member_t asn_MAP_NGAP_PathSwitchRequestTransfer_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* userPlaneSecurityInformation */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* qosFlowAcceptedList */
