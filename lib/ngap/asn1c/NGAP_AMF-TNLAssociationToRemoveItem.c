...
static asn_TYPE_member_t asn_MBR_NGAP_AMF_TNLAssociationToRemoveItem_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_AMF_TNLAssociationToRemoveItem, iE_Extensions),
		...
		&asn_DEF_NGAP_ProtocolExtensionContainer_5591P17,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static asn_SEQUENCE_specifics_t asn_SPC_NGAP_AMF_TNLAssociationToRemoveItem_specs_1 = {
