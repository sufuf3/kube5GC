...
#define NGAP_ProcedureCode_id_Paging	((NGAP_ProcedureCode_t)22)
#define NGAP_ProcedureCode_id_PathSwitchRequest	((NGAP_ProcedureCode_t)23)
#define NGAP_ProcedureCode_id_PDUSessionResourceModify	((NGAP_ProcedureCode_t)24)
#define NGAP_ProcedureCode_id_PDUSessionResourceModifyIndication	((NGAP_ProcedureCode_t)25)
#define NGAP_ProcedureCode_id_PDUSessionResourceRelease	((NGAP_ProcedureCode_t)26)
#define NGAP_ProcedureCode_id_PDUSessionResourceSetup	((NGAP_ProcedureCode_t)27)
#define NGAP_ProcedureCode_id_PDUSessionResourceNotify	((NGAP_ProcedureCode_t)28)
#define NGAP_ProcedureCode_id_PrivateMessage	((NGAP_ProcedureCode_t)29)
#define NGAP_ProcedureCode_id_PWSCancel	((NGAP_ProcedureCode_t)30)
#define NGAP_ProcedureCode_id_PWSFailureIndication	((NGAP_ProcedureCode_t)31)
#define NGAP_ProcedureCode_id_PWSRestartIndication	((NGAP_ProcedureCode_t)32)
#define NGAP_ProcedureCode_id_RANConfigurationUpdate	((NGAP_ProcedureCode_t)33)
#define NGAP_ProcedureCode_id_RerouteNASRequest	((NGAP_ProcedureCode_t)34)
#define NGAP_ProcedureCode_id_TraceFailureIndication	((NGAP_ProcedureCode_t)35)
#define NGAP_ProcedureCode_id_TraceStart	((NGAP_ProcedureCode_t)36)
#define NGAP_ProcedureCode_id_UECapabilityInfoIndication	((NGAP_ProcedureCode_t)37)
#define NGAP_ProcedureCode_id_UEContextModification	((NGAP_ProcedureCode_t)38)
#define NGAP_ProcedureCode_id_UEContextRelease	((NGAP_ProcedureCode_t)39)
#define NGAP_ProcedureCode_id_UEContextReleaseRequest	((NGAP_ProcedureCode_t)40)
#define NGAP_ProcedureCode_id_UERadioCapabilityCheck	((NGAP_ProcedureCode_t)41)
#define NGAP_ProcedureCode_id_UETNLABindingRelease	((NGAP_ProcedureCode_t)42)
#define NGAP_ProcedureCode_id_UplinkNASTransport	((NGAP_ProcedureCode_t)43)
#define NGAP_ProcedureCode_id_UplinkNonUEAssociatedNRPPaTransport	((NGAP_ProcedureCode_t)44)
#define NGAP_ProcedureCode_id_UplinkRANConfigurationTransfer	((NGAP_ProcedureCode_t)45)
#define NGAP_ProcedureCode_id_UplinkRANStatusTransfer	((NGAP_ProcedureCode_t)46)
#define NGAP_ProcedureCode_id_UplinkUEAssociatedNRPPaTransport	((NGAP_ProcedureCode_t)47)
#define NGAP_ProcedureCode_id_WriteReplaceWarning	((NGAP_ProcedureCode_t)48)
