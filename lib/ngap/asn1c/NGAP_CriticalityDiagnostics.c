...
static asn_TYPE_member_t asn_MBR_NGAP_CriticalityDiagnostics_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_CriticalityDiagnostics, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_5591P41,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static asn_SEQUENCE_specifics_t asn_SPC_NGAP_CriticalityDiagnostics_specs_1 = {
