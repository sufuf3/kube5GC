...
static asn_TYPE_member_t asn_MBR_NGAP_PDUSessionResourceModifyResponseTransfer_1[] = {
	{ ATF_POINTER, 4, offsetof(struct NGAP_PDUSessionResourceModifyResponseTransfer, dL_NGU_UP_TNLInformation),
	...
	{ ATF_POINTER, 3, offsetof(struct NGAP_PDUSessionResourceModifyResponseTransfer, qosFlowAddOrModifyResponseList),
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_PDUSessionResourceModifyResponseTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_5591P75,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_NGAP_PDUSessionResourceModifyResponseTransfer_oms_1[] = { 0, 1, 2, 3 };
...
static const asn_TYPE_tag2member_t asn_MAP_NGAP_PDUSessionResourceModifyResponseTransfer_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* qosFlowAddOrModifyResponseList */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* qosFlowFailedToAddOrModifyList */
