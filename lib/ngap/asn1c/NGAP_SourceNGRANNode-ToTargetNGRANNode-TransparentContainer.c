...
static asn_TYPE_member_t asn_MBR_NGAP_SourceNGRANNode_ToTargetNGRANNode_TransparentContainer_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NGAP_SourceNGRANNode_ToTargetNGRANNode_TransparentContainer, indexToRFSP),
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_SourceNGRANNode_ToTargetNGRANNode_TransparentContainer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_5591P108,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_NGAP_SourceNGRANNode_ToTargetNGRANNode_TransparentContainer_oms_1[] = { 1, 2, 4, 5 };
