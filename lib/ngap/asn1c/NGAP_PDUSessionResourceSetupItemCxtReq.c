...
static asn_TYPE_member_t asn_MBR_NGAP_PDUSessionResourceSetupItemCxtReq_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_PDUSessionResourceSetupItemCxtReq, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_5591P7,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static asn_SEQUENCE_specifics_t asn_SPC_NGAP_PDUSessionResourceSetupItemCxtReq_specs_1 = {
