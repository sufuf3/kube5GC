...
static asn_TYPE_member_t asn_MBR_NGAP_AMF_TNLAssociationToUpdateItem_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NGAP_AMF_TNLAssociationToUpdateItem, tNLAssociationWeightFactor),
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_AMF_TNLAssociationToUpdateItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_5591P18,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const asn_TYPE_tag2member_t asn_MAP_NGAP_AMF_TNLAssociationToUpdateItem_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* tNLAssociationWeightFactor */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* iE-Extensions */
};
static asn_SEQUENCE_specifics_t asn_SPC_NGAP_AMF_TNLAssociationToUpdateItem_specs_1 = {
