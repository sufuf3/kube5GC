        ...
        amf4g_ue_t *amf4g_ue, nas_attach_request_t *attach_request)
{
     ...
     *   Update KeNB
     */
    CLEAR_EPS_BEARER_ID(amf4g_ue);
    CLEAR_PAGING_INFO(amf4g_ue);
    if (SECURITY_CONTEXT_IS_VALID(amf4g_ue))
    {
        amf4g_kdf_enb(amf4g_ue->kasme, amf4g_ue->ul_count.i32, amf4g_ue->kenb);
    ...
    if (served_tai_index < 0)
    {
        ...
        d_warn("Cannot find Served TAI[PLMN_ID:0x%x,TAC:%d]",
            amf4g_ue->tai.plmn_id, amf4g_ue->tai.tac);
        nas_send_attach_reject(amf4g_ue,
        ...
        NAS_ATTACH_REQUEST_LAST_VISITED_REGISTERED_TAI_PRESENT)
    {
        ...
        memcpy(&amf4g_ue->visited_plmn_id, 
                &last_visited_registered_tai->plmn_id, PLMN_ID_LEN);
    }
    else
    {
        memcpy(&amf4g_ue->visited_plmn_id, &amf4g_ue->tai.plmn_id, PLMN_ID_LEN);
    }

    memcpy(&amf4g_ue->ue_network_capability, 
    ...
    {
        memcpy(&amf4g_ue->ms_network_capability, 
    ...
    switch(eps_mobile_identity->imsi.type)
    {
        case NAS_EPS_MOBILE_IDENTITY_IMSI:
        {
            ...
            nas_imsi_to_bcd(
                ...
                imsi_bcd);
            amf4g_ue_set_imsi(amf4g_ue, imsi_bcd);
    ...
    NAS_STORE_DATA(&amf4g_ue->pdn_connectivity_request, esm_message_container);
    ...
    amf4g_ue_t *amf4g_ue, nas_attach_complete_t *attach_complete)
{
    ...
    rv = nas_send_emm_to_esm(amf4g_ue, &attach_complete->esm_message_container);
        ...
        amf4g_ue_t *amf4g_ue, nas_identity_response_t *identity_response)
{
    ...
    if (mobile_identity->imsi.type == NAS_IDENTITY_TYPE_2_IMSI)
    {
        ...
        d_assert(amf4g_ue->imsi_len, return CORE_ERROR,
        ...
        amf4g_ue_t *amf4g_ue, nas_tracking_area_update_request_t *tau_request)
{
    ...
    if (served_tai_index < 0)
    {
        ...
        d_warn("Cannot find Served TAI[PLMN_ID:0x%x,TAC:%d]",
            amf4g_ue->tai.plmn_id, amf4g_ue->tai.tac);
        nas_send_tau_reject(amf4g_ue, EMM_CAUSE_TRACKING_AREA_NOT_ALLOWED);
        return CORE_ERROR;
    }
    d_trace(5, "    SERVED_TAI_INDEX[%d]\n", served_tai_index);
